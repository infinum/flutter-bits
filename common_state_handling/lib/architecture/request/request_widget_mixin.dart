...
abstract class RequestWidgetMixin<E> {
  Widget getErrorWidgetWithButton(BuildContext context, ErrorRequestWidgetBuilder<E> buildError, ErrorDetails<E> state,
      bool retryEnabled, VoidCallback onRetry, VoidCallback performRequest, VoidCallback onPressed) {
    return Column(
      children: <Widget>[
  ...
  Widget getErrorWidget(BuildContext context, ErrorRequestWidgetBuilder<E> buildError, ErrorDetails<E> state,
  ...
  VoidCallback _getRetryCallback(bool retryEnabled, VoidCallback onRetry, VoidCallback performRequest) {
    if (retryEnabled) {
      assert(
          onRetry != null || performRequest != null, "Retry is enabled, but both onRetry and performRequest are null!");
